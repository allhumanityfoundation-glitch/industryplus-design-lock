    ...
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <div className="flex-1 flex items-center justify-center px-6">
        <div className="w-full max-w-[400px]">
          <h1 className="text-[28px] font-bold tracking-tight mb-8">What&apos;s your email?</h1>

          <div className="space-y-4">
            <input type="email" placeholder="Enter email" className="uber-input" />
          ...
          <div className="space-y-3">
            <button className="w-full flex items-center justify-center gap-3 py-3 px-4 bg-gray-100 rounded-full text-sm font-medium hover:bg-gray-200 transition-colors">
            ...
            <button className="w-full flex items-center justify-center gap-3 py-3 px-4 bg-black text-white rounded-full text-sm font-medium hover:bg-gray-900 transition-colors">
          ...
          <p className="text-xs text-gray-400 mt-8 leading-relaxed">
            By proceeding, you consent to get calls, WhatsApp or SMS messages from IndustryPlus.
          </p>

          <p className="text-sm text-gray-500 mt-6 text-center">
            Are you a company? <Link href="/carrier" className="font-medium text-black underline underline-offset-4">Sign in here</Link>
          </p>
        </div>
      </div>
    </div>
